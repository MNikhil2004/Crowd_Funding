...
.then(client=>{
    //get db obj
    const fundsdb=client.db('fundsdb')
    //get collection obj
    const usercollection=fundsdb.collection('usercollection')
    const donorcollection=fundsdb.collection('donorcollection')
    // const authorscollection=fundsdb.collection('authorscollection')
